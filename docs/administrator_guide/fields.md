...
| Calculated               | Password Protected            | Single Choice     | Indicates the documents that were password protected. It contains the value False if the file was never password protected, Decrypted if the password was identified, True if the password was not identified.|
