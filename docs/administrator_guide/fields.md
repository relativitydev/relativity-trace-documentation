...
| **Trace Field Note** | **Relativity Field**          | **Field Type**    | **Field Description**                                        |
| ------------------------ | ----------------------------- | ----------------- | ------------------------------------------------------------ |
...
| [Calculated ](https://relativitydev.github.io/relativity-trace-documentation/docs/user_guide/enrichment/artificial_intelligence.html#fields) | Trace Primary Language        | Fixed-Length Text | Describes the primary language used in a communication |
| [Calculated ](https://relativitydev.github.io/relativity-trace-documentation/docs/user_guide/enrichment/artificial_intelligence.html#fields)                        | Trace Other Languages         | Long Text         | Describes the type other language used in a communication |
...
| [Calculated ](https://relativitydev.github.io/relativity-trace-documentation/docs/user_guide/enrichment/artificial_intelligence.html#fields)                        | Trace Is Spam                 | Yes/No            | Describes if a communication is spam or not spam |
