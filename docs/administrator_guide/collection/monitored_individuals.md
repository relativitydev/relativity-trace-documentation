...
It is also possible to automatically add / update / remove Monitored Individuals via [Extensible API's]({% link /docs/administrator_guide/proactive_ingestion_api_documentation.md %}).
{: .info } 
