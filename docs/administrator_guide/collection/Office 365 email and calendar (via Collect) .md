...
![@startuml autonumber  box "Client Controlled" #LightGreen     participant Office365 end box  box "Relativity" #LightBlue     participant Collect     participant Trace     participant Workspace end box  group Manual OneTime Setup     Trace -> Trace: Authentication     Trace -> Trace: Configure     Trace -> Trace: Set Start Date end  group Trace Run | Every X hrs     Trace -> Collect: Request data | filters: MIs, date range, other     Office365 -> Collect: Requested Data     Collect -> Trace: Requested Data     Trace -> Trace: Process     Trace -> Workspace: Ingest end group @endum](C:\Users\david.bachmann\Documents\GitHub\relativity-trace-documentation\docs\administrator_guide\collection\media\Installing_and_configuring_Trace_data_sources\deploymentBOffice 365) 
...
![img](C:\Users\david.bachmann\Documents\GitHub\relativity-trace-documentation\docs\administrator_guide\collection\media\Installing_and_configuring_Trace_data_sources\clientsecrets)
...
![image-20220516065831419](C:\Users\david.bachmann\Documents\GitHub\relativity-trace-documentation\docs\administrator_guide\collection\media\Installing_and_configuring_Trace_data_sources\newclientsecret)
...
![img](C:\Users\david.bachmann\Documents\GitHub\relativity-trace-documentation\docs\administrator_guide\collection\media\Installing_and_configuring_Trace_data_sources\datasourcespecificfields) 
