...
| 4/28/2028  | na    | Task Configuration | `Perform Term Searching On Trace Cleansed Extracted Text` checkbox does not control what text is used for Term Searching, instead the field in the All Documents Saved Search will still be honored. | No |
