...
| Calculated               | File Size                     | Decimal           | This field is automatically provided by Relativity on import. However, this field can also be calculated and set by Trace. Trace calculates this field as the size of the native file. **IMPORTANT:** Since both Relativity and Trace can provide a value for this field, it is up to user to decide how to use this field and decide which value to store.                                                      |
