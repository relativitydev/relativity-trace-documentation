...
`Email Settings – Body Template`: Enter text that you would like to appear above the list of slerted documents. Can also insert custom HTML.
...
`Document Link` - By default contains document identifier that is a link to the alerted document.

`Document Text` – Text that appears next to the Document Link.


**askdsfjakdfjsSample Email generated by Trace**
