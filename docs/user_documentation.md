...
For any of the following settings, you can insert custom text and Replacement Tokens.

`Email Settings – Body Template`: Customize text that appears above the list of alerted documents.
...
`Document Link` - By default contains a link to the alerted document.

`Document Text` – Text that appears next to the Document Link.
...
`Slack Settings - Message Template` – Customize text that appears above the list of alerted documents.
...
`Document Link` - By default contains document identifier that links to the alerted document.

`Document Text` – metadata and link to alerted documents in
Relativity
