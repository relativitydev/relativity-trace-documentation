...
`Email Settings – Body Template`: Enter text that you would like to appear above the 

Body of the email (can insert custom text, 
...
`Document Link` - by default contains document identifier

`Document Text` – allows for custom text and includes document identifier, link to document in Relativity
